  ...
  for ( i= 0; i < 7; ++i )
    {
      ...
      /* Dibuixa. */
      draw_background ();
      tiles8b_draw_string ( _fb, WIDTH, "TECLAT", 1, 6, _style.fgcolor,
        		    0, BG_TRANS );
      tiles8b_draw_string ( _fb, WIDTH, text[i], 1, 7, _style.selcolor,
        		    0, BG_TRANS );
      screen_update ( _fb, NULL );
           ...
           )
{
  ...
  draw_background ();
  tiles8b_draw_string ( _fb, WIDTH, "AJUDA", 7, 2,
        		_style.selcolor, 0, BG_TRANS );
  tiles8b_draw_string ( _fb, WIDTH, "DESA EST.: CTR+1-5", 1, 5,
        		_style.fgcolor, 0, BG_TRANS );
  tiles8b_draw_string ( _fb, WIDTH, "LLIG EST.: ALT+1-5", 1, 7,
        		_style.fgcolor, 0, BG_TRANS );
  tiles8b_draw_string ( _fb, WIDTH, "CAP. PAN.: CTR+S", 1, 9,
        		_style.fgcolor, 0, BG_TRANS );
  tiles8b_draw_string ( _fb, WIDTH, "SURT-SUS.: CTR+Q", 1, 11,
        		_style.fgcolor, 0, BG_TRANS );
  tiles8b_draw_string ( _fb, WIDTH, "MENu:      ESC", 1, 13,
        		_style.fgcolor, 0, BG_TRANS );
  tiles8b_draw_string ( _fb, WIDTH, "           C. DRET", 1, 15,
        		_style.fgcolor, 0, BG_TRANS );
  draw_cursor ( mst );
  screen_update ( _fb, NULL );
...
#if 0
  /* VELLS !!*/
  _style.bgcolor= 0xFFF; /* Blanc. */
  _style.fgcolor= 0x666; /* Gris. */
  _style.selcolor= 0xB32; /* Blau SEGA. */
#endif
  _style.fgcolor= 0xFFF; /* Blanc. */
  _style.selcolor= 0x00F; /* Roig. */
  _style.cursor_black= 0x000;
  _style.cursor_white= 0xBBB;
