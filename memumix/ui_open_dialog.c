 ...
 */
/*
 *  ui_open_dialog.c - Implementació de 'ui_open_dialog.h'.
 *
 */
                    ...
                    )
{
  ...
  ui_open_dialog_t *new;
  ui_button_t *b1;
  int tmp_x,tmp_y;
  
  
  new= g_new ( ui_open_dialog_t, 1 );
  ...
  new->_fchooser=
    ui_file_chooser_new ( new->_x + MARGIN,
                          ...
                          cdir, true, empty_entry,
                          selector, cb_sel_file, new );
...
{
  return ui_file_chooser_get_current_file ( self->_fchooser );
...
} // end ui_open_dialog_set_user_data
