        	    ...
        	    )
{
  ...
  conf->keys[0].button_B= SDLK_z;
  conf->keys[0].button_A= SDLK_x;
  ...
  conf->keys[1].button_B= SDLK_j;
  conf->keys[1].button_A= SDLK_k;
  conf->keys[1].select= SDLK_o;
  conf->keys[1].start= SDLK_p;
